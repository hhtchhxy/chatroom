...
namespace ChatRoom.ChatServerApi.SerivceExtention
{
    public static class ChatServiceApiExtensions
    {
        private static readonly ILogger _logger;

        static ChatServiceApiExtensions()
        {
            var loggerFactory = LoggerFactory.Create(builder =>
            {
                builder.AddConsole();
            });
            _logger = _logger = loggerFactory.CreateLogger("ChatServiceApiExtensions");
        }
        public static void ChatServiceApiConfigure(this IServiceCollection services, IHostEnvironment hostingEnvironment)
        {
